...
- Added regression coverage for GLB companion URL resolution, companion asset URI rewriting, missing vertex color fallback detection, and WebGL texture color baking
