...
```kotlin
implementation("codes.yousef.sigil:sigil-compose:0.2.7.9")
implementation("codes.yousef.sigil:sigil-schema:0.2.7.9")

// For SSR with Ktor, Spring Boot, or Quarkus:
implementation("codes.yousef.sigil:sigil-summon:0.2.7.9")
```
