...
```kotlin
implementation("codes.yousef.sigil:sigil-compose:0.3.3.0")
implementation("codes.yousef.sigil:sigil-schema:0.3.3.0")

// For SSR with Ktor, Spring Boot, or Quarkus:
implementation("codes.yousef.sigil:sigil-summon:0.3.3.0")
```
