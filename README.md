...
```kotlin
implementation("codes.yousef.sigil:sigil-compose:0.4.0.2")
implementation("codes.yousef.sigil:sigil-schema:0.4.0.2")

// For SSR with Ktor, Spring Boot, or Quarkus:
implementation("codes.yousef.sigil:sigil-summon:0.4.0.2")
```
