...
class SigilSummonContextTest {
    ...
    fun enterGroup_exitGroup_createsNestedStructure() {
        ...
        val groupChildren = mutableListOf<codes.yousef.sigil.schema.SigilNodeData>()
    ...
    fun nestedGroups_createDeepHierarchy() {
        ...
        val innerChildren = mutableListOf<codes.yousef.sigil.schema.SigilNodeData>()
        context.enterGroup(innerChildren)
        context.registerNode(MeshData(id = "deep-mesh"))
        context.exitGroup()
        
        val outerChildren = mutableListOf<codes.yousef.sigil.schema.SigilNodeData>()
    ...
    fun buildScene_sceneIsSerializable() {
        ...
        val restored = codes.yousef.sigil.schema.SigilScene.fromJson(json)
    ...
    fun complexScene_buildsCorrectly() {
        ...
        val objectsChildren = mutableListOf<codes.yousef.sigil.schema.SigilNodeData>()
